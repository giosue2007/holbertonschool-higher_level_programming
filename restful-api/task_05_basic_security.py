#!/usr/bin/python3
"""Module that implements API security with basic and JWT authentication."""
...
@auth.login_required
def basic_protected():
    """Returns a message if basic authentication is successful."""
...
@jwt_required()
def jwt_protected():
    """Returns a message if JWT authentication is successful."""
